...
public class CreateInstructorDemo {
	...
	public static void main(String[] args) {
		// Create session factory
				...
				try{
					//Create the object
					Instructor newInstructor = new Instructor("Ranjith","Wick","Ranjith.wick@gmail.com");
					InstructorDetail newInstructorDetail = new InstructorDetail("www.youtube.com/Ranjith.wick","WHISKY TALK");
